...
/* harmony import */ var _vendor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vendor */ "./js/vendor.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var ESC_KEY = 'Esc';
  var menuButton = document.querySelector('[data-open-menu]');
  ...
  var accordionButtons = document.querySelectorAll('[data-closed-accordion]');
  var accordionCloseButtons = document.querySelectorAll('[data-accorion-btn]');
  accordionCloseButtons.forEach(function (accordionCloseButton) {
    accordionCloseButton.addEventListener('click', function () {
      var contentBlock = accordionCloseButton.closest('[data-accodion-item]');
  ...
  accordionButtons.forEach(function (accodionButton) {
    accodionButton.addEventListener('click', function () {
      var contentBlock = accodionButton.closest('[data-accodion-item]');
  ...
  var filterButtons = document.querySelectorAll('[data-open-filter-list]');
  var fildsetButtons = document.querySelectorAll('[data-open-filter-button]');
  filterButtons.forEach(function (filterButton) {
    filterButton.addEventListener('click', function () {
      var filterBlock = filterButton.closest('[data-filter-button]');
  ...
  fildsetButtons.forEach(function (fildsetButton) {
    fildsetButton.addEventListener('click', function () {
      var filterBlock = fildsetButton.closest('[data-filter-button]');
  ...
  var filterOpenButtons = document.querySelectorAll('[data-open-filter]');
  var filter = document.querySelector('.catalog-filter');
  var filterCloseButtons = document.querySelectorAll('[data-close-filter]');
  var filterOverlay = document.querySelector('[data-close-modal-filter]');
  ...
  filterOpenButtons.forEach(function (filterOpenButton) {
  ...
  filterCloseButtons.forEach(function (filterCloseButton) {
  ...
  window.addEventListener('keydown', function (evt) {
    var isEscKey = evt.key === ESCAPE_KEY || evt.key === ESC_KEY;
  ...
  window.addEventListener('load', function () {
    ...
    Object(_vendor__WEBPACK_IMPORTED_MODULE_2__["initSwiper"])();
  });
}); // ---------------------------------
...
var initSwiper = function initSwiper() {
  var swiper = new Swiper('.preview__wrapper', {
    observer: true,
    observeParents: true,
    loop: false,
    freeMode: true,
    ...
    pagination: {
      ...
      renderBullet: function renderBullet(index, className) {
        ...
        return "<li class=\"preview__toggle-item ".concat(className, "\">\n        <button type=\"button\">").concat(index + 1, "</button>\n      </li>");
      }
    },
    breakpoints: {
      320: {
